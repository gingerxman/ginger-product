...
import (
	...
	_ "github.com/gingerxman/ginger-product/models/product"
	_ "github.com/gingerxman/ginger-product/models/material"
	_ "github.com/gingerxman/ginger-product/models/cart"
)
...
func init() {
	...
	if err != nil {
		eel.Logger.Fatalw("[db] connect to mysql fail!!", "error", err.Error())
	} else {
